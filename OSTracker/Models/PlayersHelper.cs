...
namespace OSTracker.Models
{
    public class PlayersHelper
    {
        ...
        public List<SkillsHelper.SkillData> skills { get; set; }
        public List<QuestsHelper.QuestData> quests { get; set; }

        public static PlayersHelper Lookup(string username)
        {
        ...
        public static PlayersHelper GetPlayer(string username)
        {
            return null;
